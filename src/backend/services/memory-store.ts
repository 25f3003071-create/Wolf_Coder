...
export class InMemoryDatabase {
  ...
  private seedDefaults() {
    ...
    this.beneficiaries.set('BEN-72A91', {
      ...
      age: 48,
      gender: 'Female',
      address: 'Village Rampur, Ward 4',
      city_district: 'Shimla',
      emergency_need: 'Emergency Cardiac Bypass Surgery & Intensive Care',
      family_members: 4,
      priority: 'CRITICAL',
      requested_amount: 78500,
      approved_amount: 50000,
      spent_amount: 15000,
      remaining_amount: 35000,
      aid_category: 'Medical',
      description: 'Emergency cardiac procedure for 48yo sole earner from rural district.',
      category: 'MEDICAL',
    ...
    this.beneficiaries.set('BEN-48B12', {
      ...
      age: 34,
      gender: 'Male',
      address: 'Sector 12 Block B',
      city_district: 'Ambala',
      emergency_need: 'Motorized Wheelchair & Rehabilitation Support',
      family_members: 3,
      priority: 'HIGH',
      ...
      spent_amount: 40000,
      remaining_amount: 0,
      aid_category: 'Disability Relief',
      description: 'Assistance for mobility restoration post-accident.',
      category: 'DISABILITY',
      aid_required: 'Motorized Wheelchair & Rehab',
      status: 'FULLY_DISBURSED',
      hospital_name: 'City Rehabilitation Center',
      treatment_type: 'Rehabilitation',
      estimated_cost: 45000,
      anonymized_summary: 'Assistance for mobility restoration post-accident.',
      created_at: '2026-08-18T12:00:00Z',
      updated_at: '2026-08-21T15:00:00Z',
    });

    // Seed default Disbursement for BEN-72A91
    this.aidDisbursements.set('AID-2026-001241', {
      ...
      amount: 15000,
      aid_type: 'Medical Surgery Advance',
      payment_method: 'UPI',
      payment_status: 'COMPLETED',
      payment_reference: 'UPI-REF-9918230',
      blockchain_tx_hash: 'SIMULATED-0x8a7291bc44f128e9',
      blockchain_tx_status: 'SIMULATED_TRANSACTION',
      payment_mode: 'DEVELOPMENT_SIMULATION',
      notes: 'Initial OT booking deposit transferred to hospital vendor.',
      created_at: '2026-08-22T09:15:00Z',
    });

    // Seed default Document for BEN-72A91
    this.beneficiaryDocuments.set('DOC-2026-009181', {
      id: 'DOC-2026-009181',
      beneficiary_id: 'BEN-72A91',
      ngo_id: 'NGO-1042',
      document_type: 'Hospital Estimate',
      filename: 'hospital_surgery_estimate.pdf',
      mime_type: 'application/pdf',
      file_size: 1048576,
      storage_path: 'documents/ben-72a91_hospital_estimate.pdf',
      uploaded_by: 'Red Cross Field Officer',
      created_at: '2026-08-20T10:30:00Z',
    });

    // Seed default Demo Receipt DR-2026-8F72K9
